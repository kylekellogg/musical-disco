...
function weightedRand() {
  var weightsAndVals = arguments.length <= 0 || arguments[0] === undefined ? [{ weight: 1, value: 1 }] : arguments[0];

  var total = weightsAndVals.reduce(function (p, c) {
    return { weight: p.weight + c.weight };
  }, { weight: 0 }).weight;
  var ran = rand(0, total);
  var r = void 0;
  weightsAndVals.some(function (x) {
    r = x.value;
...
function flavorForVal(val) {
  ...
  if (val > 1) {
    flavors = ['Cake!', 'Ice Cream!', 'Baked Goods for Breakfast!'];
  } else if (val < 0) {
    flavors = ['Jogging', 'Hitting the Gym', 'Biking to Work'];
  } else {
    flavors = ['Grilled Chicken Dinner', 'Salad for Lunch', 'A Heaping Portion of Vegetables'];
  }
...
function addCardOfType(type) {
  ...
  switch (type) {
    case SPLURGE:
      val = weightedRand([{ value: 2, weight: 0.6 }, { value: 3, weight: 0.25 }, { value: 4, weight: 0.1 }, { value: 5, weight: 0.05 }]);
      return {
        type: type,
        value: val,
    ...
    case WORK_IT:
      val = weightedRand([{ value: -1, weight: 0.75 }, { value: -2, weight: 0.17 }, { value: -3, weight: 0.08 }]);
      return {
        type: type,
        value: val,
        flavor: flavorForVal(val)
...
console.log(Array.from(new Array(6), function (v, i) {
  return i;
}).map(function () {
  return weightedRand([{ value: -1, weight: 0.75 }, { value: -2, weight: 0.17 }, { value: -3, weight: 0.08 }]);
}));
var splurgeCards = Array.from(new Array(50), function (v, i) {
  return i;
}).map(function () {
  return addCardOfType(SPLURGE);
});
var necessityCards = Array.from(new Array(35), function (v, i) {
  return i;
}).map(function () {
  return addCardOfType(NECESSITY);
});
var workItCards = Array.from(new Array(15), function (v, i) {
  return i;
}).map(function () {
  return addCardOfType(WORK_IT);
});
var shuffledCards = shuffle([].concat(_toConsumableArray(splurgeCards), _toConsumableArray(necessityCards), _toConsumableArray(workItCards)));
var shuffledCardsCopy = shuffledCards.slice();
var cards = [];
...
var Player = function () {
  ...
  _createClass(Player, [{
    ...
    value: function playCard() {
      ...
      var idx = Math.floor(rand(0, this.hand.length));
      var choice = this.hand[idx];
      ...
      this.inPlay.sort(function (a, b) {
        var fA = a.flavor.split().reduce(function (p, c) {
          return p + c.charCodeAt(0);
        }, 0);
        var fB = b.flavor.split().reduce(function (p, c) {
          return p + c.charCodeAt(0);
        }, 0);
      ...
      var dupes = [];
      this.inPlay.forEach(function (x, i, a) {
        var prevIdx = Math.max(i - 1, 0);
        if (prevIdx === i) return;

        var prev = _this.inPlay[prevIdx];
        if (x.flavor === prev.flavor) {
          var dupeIdx = void 0;
          dupes.some(function (y, yi) {
      ...
      dupes.forEach(function (dupe) {
        if (dupe.run >= 3) {
          _this.inPlay.splice(dupe.start, dupe.run);
          dupe.cards.forEach(function (card) {
            _this.score -= card.value;
          });
        }
      });
    }
...
function playGame() {
  var cardArr = shuffledCardsCopy.slice();
  var players = [new Player('A'), new Player('B')];

  //  Initial hand
  Array.from(new Array(10), function (v, i) {
    return i;
  }).map(function () {
    players.forEach(function (player) {
      player.addCard.apply(player, _toConsumableArray(cardArr.splice(0, 1)));
    });
  });

  while (cardArr.length) {
    var _players$, _players$2;

    (_players$ = players[0]).addCard.apply(_players$, _toConsumableArray(cardArr.splice(0, 1)));
    players[0].playCard();

    if (cardArr.length) (_players$2 = players[1]).addCard.apply(_players$2, _toConsumableArray(cardArr.splice(0, 1)));
    players[1].playCard();
  }

  while (players.some(function (x) {
    return x.hand.length;
  })) {
...
var Card = function Card(_ref) {
  ...
  return _react2.default.createElement(
    'div',
    { className: 'card card--' + type.toLowerCase().replace(/_/g, '-') + ' col-md-1 col-sm-3' },
...
var CardRow = function CardRow(_ref2) {
  var subcards = _ref2.subcards;
  return _react2.default.createElement(
    'div',
    { className: 'card-row row' },
    subcards.map(function (card, idx) {
      return _react2.default.createElement(Card, _extends({ key: idx }, card));
    })
  );
};
  ...
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      ...
      _react2.default.createElement(
        ...
        _react2.default.createElement(
          'button',
          { onClick: playGame, className: 'btn btn-default' },
          'Play Game'
        )
      )
    ),
    cards.map(function (subcards, idx) {
      return _react2.default.createElement(CardRow, { key: idx, subcards: subcards });
    })
  );
};
